...
product_URL = environ.get('product_URL')  or 'http://raffleoak.tech:5000/raffle_company' 
transaction_URL = environ.get('transaction_URL') or 'http://raffleoak.tech:5006/add_transactions'
