...
record_URL = environ.get('record_URL') or "http://localhost:5000/record" or 'http://100.25.39.15:5000/record' 
# deduct_URL = "http://localhost:5000/deduct_product/"
location_URL = environ.get('location_URL') or  "http://localhost:5007/location" or 'http://100.25.39.15:5007/location' 
